...
return [
    ...
    'KASHIER_WEBHOOK_URL' => env('KASHIER_WEBHOOK_URL'),
     ...
     #FAWRY LIVE 
     'FAWRY_URL' => env('FAWRY_URL', "https://atfawry.com/"), //https://www.atfawry.com/ for production
     'FAWRY_SECRET' => env('FAWRY_SECRET', '5fcfbb51-ac04-4209-a2f1-0f376b9b82b5'),
     'FAWRY_MERCHANT' => env('FAWRY_MERCHANT', '400000018851'),
    ...
    // 'FAWRY_SECRET' => env('FAWRY_SECRET', '107c0d6f-f972-4d32-a2f6-b21f0f3473c2'),
    // 'FAWRY_MERCHANT' => env('FAWRY_MERCHANT', '770000019524'),
    // 'FAWRY_DISPLAY_MODE' => env('FAWRY_DISPLAY_MODE', "POPUP"), //required allowed values [POPUP, INSIDE_PAGE, SIDE_PAGE , SEPARATED]
    // 'FAWRY_PAY_MODE' => env('FAWRY_PAY_MODE', "CARD"), //allowed values ['CashOnDelivery', 'PayAtFawry', 'MWALLET', 'CARD' , 'VALU']
