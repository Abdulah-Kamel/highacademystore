    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h6 class="card-title mb-0">إضافة محافظة جديدة</h6>
            ...
            <div class="card-body">
                <form action="{{ route('dashboard.governorates.store') }}" method="POST" id="governorateForm">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('governorate_name_ar') }}" placeholder="أدخل اسم المحافظة بالعربية"
                                    required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('governorate_name_en') }}" placeholder="Enter governorate name in English"
                                    required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="home_shipping_price" class="form-label">سعر التوصيل للمنزل (جنيه)
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('home_shipping_price', 0) }}"
                                       placeholder="0.00"
                                       step="0.01"
                                       min="0"
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="post_shipping_price" class="form-label">سعر التوصيل لمكتب البريد (جنيه)
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="number"
                                       ...
                                       value="{{ old('post_shipping_price', 0) }}"
                                       placeholder="0.00"
                                       step="0.01"
                                       min="0"
                                       required>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save me-2"></i>حفظ المحافظة
                        </button>
                    </div>
                </form>
            </div>
