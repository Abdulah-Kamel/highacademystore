            ...
            <ul class="menu-list">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse {{ (request()->segment(2) == 'dashboard') && (request()->segment(3) == '') ? 'show' : '' }}"
                        id="my_dashboard">
                        <li><a class="ms-link {{ (request()->segment(2) == 'dashboard') && (request()->segment(3) == '') ? 'active' : '' }}"
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse {{ (request()->segment(3) == 'education-stages') ? 'show' : '' }} {{ (request()->segment(3) == 'stages') ? 'show' : '' }}"
                        id="my_dashboard5">
                        <li><a class="ms-link  {{ (request()->segment(3) == 'education-stages') && (request()->segment(4) == '') ? 'active' : '' }}"
                                href="{{ route('dashboard.education_stages') }}">المراحل التعلمية</a></li>
                        <li><a class="ms-link {{ (request()->segment(3) == 'stages') && (request()->segment(4) == 'create') ? 'active' : '' }}"
